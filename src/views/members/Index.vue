<template>
  <div class="members">
    <a-row>
      <a-col :span="24">
        <h3 class="members-title">会员版本特权对比</h3>
      </a-col>
      ...
      <a-col :span="24">
        ...
        >
          ...
          <template slot="professionalTitle">
      ...
      <a-col :span="24">
        <div class="members-more">更多功能体验，敬请期待</div>
      </a-col>
    </a-row>
  </div>
</template>
